				...
				boolean cargo = true; 
					...
					for (int i=0 ; i<largo ; i++) {
						...
						if (cargo)
						{
							...
							JOptionPane.showMessageDialog(null, "No se creÛ la Actividad por NamingException","Error", JOptionPane.WARNING_MESSAGE);
							e1.printStackTrace();
						} catch (ServiciosException e1) {
							JOptionPane.showMessageDialog(null, "No se creÛ la Actividad por ServiciosException","Error", JOptionPane.WARNING_MESSAGE);
							e1.printStackTrace();
						}
